...
<html lang="en">
	<head>
		...
		<title>Graeme's Music | Country Songs</title>
		...
		<main>
			<div class = "wrapper">
				...
				<div class="content">
					...
					<img src = "images/country/CountryCover.jpg" style = "width: 12vw; border: 2px; border-color: green; float: left; padding-left: 7.5vw; padding-right: 2vw; padding-bottom: 1.5vw;" alt = "Album Cover"> 
					<h1 style = "text-align: left; padding-top: 2vw; font-size: 3vw;">Country</h1>
					...
					WHERE g.Genre IN ('Acoustic', 'Bluegrass', 'Country', 'Easy Listening - Female', 'Easy Listening - Group', 'Easy Listening - Male', 'Folk Country', 'Mellow', 'Vocal')");
					...
					<div class = "query">
						...
						// Selects all available information on country songs and groups Artists together aswell as Genres to avoid duplicated songs. Then orders the query by Song Title in a descending order (Primary) and then Artist Name in descending order (Secondary)
						...
						FROM (
							...
							AND genre_id.Genre IN ('Acoustic', 'Bluegrass', 'Country', 'Easy Listening - Female', 'Easy Listening - Group', 'Easy Listening - Male', 'Folk Country', 'Mellow', 'Vocal')
