...
<html lang="en">
	<head>
		...
		<title>Graeme's Music | Graeme's First Query</title>
		...
		<main>
			<div class = "wrapper">
				...
				<div class="content">
					...
					<img src = "images/firstQuery/FirstQuery.jpg" style = "width: 12vw; border: 2px; border-color: green; float: left; padding-left: 7.5vw; padding-right: 2vw; padding-bottom: 1.5vw;" alt = "Album Cover"> 
					<h1 style = "text-align: left; padding-top: 2vw; font-size: 3vw;">Every Song (Titles & Artist Names in DESC Order)</h1>
					...
					<div class = "query">
						...
						// Selects all available information on the songs and groups Artists together to avoid duplicated songs. Then orders the query by Song Title in a descending order (Primary) and then Artist Name in descending order (Secondary)
