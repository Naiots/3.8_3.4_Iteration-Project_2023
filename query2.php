			...
			<div class = "wrapper">
				...
				<div class="content">
					...
					<div class = "query">
						...
						// Selects all available information on the songs and groups Artists together aswell as Genres to avoid duplicated songs. Then orders the query by Genre in an ascending order (Primary) and then Artist Name in ascending order (Secondary)
						...
						ORDER BY GenreList ASC, ArtistNames ASC");
