		...
		<main>
			<div class = "wrapper">
				...
				<div class="content">
					...
					<img src = "images/pop/PopCover.jpg" style = "width: 12vw; border: 2px; border-color: green; float: left; padding-left: 7.5vw; padding-right: 2vw; padding-bottom: 1.5vw;" alt = "Album Cover"> 
